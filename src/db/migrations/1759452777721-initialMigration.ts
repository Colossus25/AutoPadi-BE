...
export class InitialMigration1759452777721 implements MigrationInterface {
    name = 'InitialMigration1759452777721'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "first_name" character varying, "last_name" character varying, "email" character varying NOT NULL, "password" character varying NOT NULL, "user_type" character varying, "phone" character varying, "id_type" character varying, "id_number" character varying, "id_image" text, "address" character varying, "landmark" character varying, "city" character varying, "state" character varying, "proof_of_address_image" text, "profile_picture" text, "remember_token" text, "email_verified_at" TIMESTAMP, "deleted_at" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
